package com.davidmendozamartinez.technicaltest.rickandmorty.ui.screen
...
import com.davidmendozamartinez.technicaltest.rickandmorty.databinding.ActivityMainBinding
import com.davidmendozamartinez.technicaltest.rickandmorty.ui.screen.characters.CharactersFragmentDirections
import com.davidmendozamartinez.technicaltest.rickandmorty.ui.screen.characters.Section
import com.davidmendozamartinez.technicaltest.rickandmorty.ui.screen.search.SearchFragmentDirections
import com.davidmendozamartinez.technicaltest.rickandmorty.ui.util.hide
import com.davidmendozamartinez.technicaltest.rickandmorty.ui.util.setScrimAnimation
import com.davidmendozamartinez.technicaltest.rickandmorty.ui.util.show
...
class MainActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savedInstanceState?.let {
            binding.bottomAppBarTitle.text = savedInstanceState.getString(
                KEY_SECTION_TITLE,
                getString(Section.ALL.stringResId)
            )
        }
    ...
    private fun navigateToHome(section: Section) {
        ...
        navController.navigate(CharactersFragmentDirections.actionGlobalCharactersFragment(section))
    }
